...
from basicsr.archs.Transformer_Block import trunc_normal_, xavier_init, normal_init, trunc_normal_init, \
...
class EIMNBaidu(nn.Module):
    ...
    def _load(self, path):
        ...
        ckpt = ckpt if len(ckpt) > 10 else ckpt['state_dict']
